...
void headache(int x)
{
  if(x==1) system("color 1");
  if(x==2) system("color 2");
  if(x==3) system("color 3");
  if(x==4) system("color 4");
  if(x==5) system("color 5");
  if(x==6) system("color 6");
  if(x==7) system("color 7");
  if(x==8) system("color 8");
  if(x==9) system("color 9");
}
void Hello()
{
while(true)
